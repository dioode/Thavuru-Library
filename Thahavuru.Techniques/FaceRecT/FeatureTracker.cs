...
namespace Thahavuru.Techniques.FaceRecT
{
    public class FeatureTracker
    {
        ...
        public DecoratedImageWithFeatures GetFeaturePoints(Image faceImage) 
        {
            ...
            try
            {
                ...
                return new DecoratedImageWithFeatures() { //DecoratedImage = frameImage, 
                    facialFeatureSet = faceFeatureList };                
            }
            catch (Exception ex)
            {
